...
請參閱 https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/reviewing-storagegrid-encryption-methods.html["StorageGRID 加密方法"^] 如需 StorageGRID 應用裝置所有可用加密方法的相關資訊、
...
.開始之前
檢閱相關資訊 https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/reviewing-storagegrid-encryption-methods.html["StorageGRID 加密方法"^]。
