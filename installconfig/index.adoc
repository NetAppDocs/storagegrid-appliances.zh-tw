...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["五"] 配置
[role="quick-margin-para"]
當所有節點都部署完畢後，使用 Grid Manager link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["配置網格並完成安裝"^]。
