...
NOTE: 您也可以使用設定系統 https://docs.netapp.com/us-en/storagegrid-118/primer/exploring-grid-manager.html["網格管理程式"^] 或 link:overview-of-installation-rest-apis.html["安裝API"]。
