...
[role="lead"]
前往 https://docs.netapp.com/us-en/storagegrid/index.html["StorageGRID 12.0 文檔"^]了解如何設定和使用StorageGRID 12.0 系統。
...
* https://docs.netapp.com/us-en/storagegrid-119/index.html["StorageGRID 11.9 文件"^]
