...
summary: 您可以使用維護模式來升級 E4000 控制器上的 SANtricity OS 。 
---
= 使用維護模式（ SG6160 ）升級 E4000 控制器上的 SANtricity OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. 請遵循 _E4000 和 E5800 SANtricity 軟體與韌體升級指南 _ 或 SANtricity 系統管理員線上說明中的指示、以升級 E4000 控制器的韌體和 NVSRAM 。
+
