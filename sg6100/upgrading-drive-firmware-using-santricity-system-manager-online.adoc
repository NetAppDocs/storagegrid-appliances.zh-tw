...
---
= 使用 SANtricity System Manager 線上方法（ SG6160 ）升級 SG6100 磁碟機韌體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
屬於沒有備援磁碟區的磁碟機必須使用更新 link:upgrading-drive-firmware-using-santricity-system-manager-offline.html["離線方法"]。離線方法應用於目前降級的任何集區或磁碟區群組。
