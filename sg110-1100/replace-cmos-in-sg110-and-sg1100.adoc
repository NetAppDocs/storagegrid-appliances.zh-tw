...
.開始之前
* 您有 link:verify-component-to-replace.html["已驗證需要更換 CMOS 電池的 SG110 或 SG1100"]。
* 您有 link:locating-sg110-and-sg1100-in-data-center.html["實體放置 SG110 或 SG1100 應用裝置"] 您要在資料中心更換 CMOS 電池的位置。
+
